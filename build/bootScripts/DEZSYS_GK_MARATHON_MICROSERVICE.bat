...
set JARPATH=%APP_HOME%\lib\DEZSYS_GK_MARATHON_MICROSERVICE-2.1.0.RELEASE.jar

@rem Execute DEZSYS_GK_MARATHON_MICROSERVICE
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DEZSYS_GK_MARATHON_MICROSERVICE_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
